          ...
          {userMenuOpen && (
            <>
              ...
              <div style={{
                ...
                <Link href="/profile/orders" onClick={() => setUserMenuOpen(false)} style={{ display: 'block', padding: '9px 14px', fontFamily: 'var(--font-sans)', fontSize: '0.72rem', letterSpacing: '0.08em', color: '#0f0f0f', textDecoration: 'none' }}
                  onMouseEnter={e => e.currentTarget.style.background = '#f5f3f0'}
                  onMouseLeave={e => e.currentTarget.style.background = 'transparent'}
                >
                  Mis pedidos
